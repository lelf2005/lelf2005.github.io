...
(function (vendor_qrcode) {
    ...
    function drawModules(qr, context, settings) {
        ...
        var quiet = parseInt(settings.quiet);
        var moduleSize = (settings.size - quiet * 2) / moduleCount;
        ...
        for (row = 0; row < moduleCount; row += 1) {
            for (col = 0; col < moduleCount; col += 1) {
                var l = settings.left+ quiet +  col * moduleSize;
                var t = settings.top+ quiet +   row * moduleSize;
                var w = moduleSize;
